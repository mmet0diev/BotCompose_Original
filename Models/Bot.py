...
class Bot:
    ...
    def rec_mouse(self, output_path="txt/mouse_events.txt"):
        self.m.output_file = output_path
        self.m.record()
    ...
    def rec_kb(self, output_path="txt/kb_events.txt"):
        self.kb.output_file = output_path
        self.kb.record()
